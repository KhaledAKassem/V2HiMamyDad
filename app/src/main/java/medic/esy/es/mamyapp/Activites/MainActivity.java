...
import medic.esy.es.mamyapp.Activites.manager.Home_For_Manager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //////////////////////////////////////////////////////////////
                else if (txRadio.toLowerCase().trim().equals("parenticon")) {
                    tableUser.addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            String pattern = "^[0-9]*$";
                            if (emailtx.matches(pattern)) {
                ...
                } else if (txRadio.toLowerCase().trim().equals("manager")) {

                    if (emailtx.equals("manager2018") && passwordtx.equals("manager2018")) {
                        startActivity(new Intent(MainActivity.this, Home_For_Manager.class));
                        Toast.makeText(MainActivity.this, "Welcome In manager Board", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MainActivity.this, "Incorrect email or Password for Manger", Toast.LENGTH_SHORT).show();
                    }
                }
                ////////////////////////////////////////////////////
            }
